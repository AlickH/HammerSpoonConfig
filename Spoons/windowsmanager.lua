...
hs.hotkey.bind({"shift"}, "Left",  hs.fnutils.partial(winresize, "left"))
hs.hotkey.bind({"shift"}, "Right", hs.fnutils.partial(winresize, "right"))
--hs.hotkey.bind({"ctrl","cmd"}, "Up",    hs.fnutils.partial(winresize, "up"))
hs.hotkey.bind({"shift"}, "Down",  hs.fnutils.partial(winresize, "down"))

-- Center of the screen
--hs.hotkey.bind({"shift"}, "Down", center)
...
hs.hotkey.bind({"shift"}, "Up",    hs.fnutils.partial(winresize, "max"))

-- Move between screens
hs.hotkey.bind({"alt"}, "Up",  hs.fnutils.partial(winmovescreen, "left"))
hs.hotkey.bind({"alt"}, "Down", hs.fnutils.partial(winmovescreen, "right"))